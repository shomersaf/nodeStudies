...
import { fetchCount, getCountries } from "./counterAPI"
...
export interface CounterState {
    ...
    someString: string
    countries: Array<any>
    countruesLength:number
}

const initState: CounterState = {
    value: 0,
    status: "idle",
    someString: "This is the counter:",
    countries: [],
    countruesLength:0
}
...
export const { increment, decrement, incrementByAmount, cleanHeader } = counterSlice.actions
